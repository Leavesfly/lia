package com.leavesfly.lia.analysis.stopanalyzer;
...
import com.leavesfly.lia.analysis.AnalyzerUtils;
...
public class StopAnalyzerAlternativesTest extends TestCase {
	public void testStopAnalyzer2() throws Exception {
		AnalyzerUtils.assertAnalyzesTo(new StopAnalyzer2(), "The quick brown...", new String[] {
				"quick", "brown" });
	}
