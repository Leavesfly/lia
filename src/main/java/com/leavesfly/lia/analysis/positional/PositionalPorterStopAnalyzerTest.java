package com.leavesfly.lia.analysis.positional;
...
public class PositionalPorterStopAnalyzerTest extends TestCase {
	...
	public void setUp() throws Exception {
		...
		IndexWriter writer = new IndexWriter(directory, porterAnalyzer,
	...
	public void testStems() throws Exception {
		Query query = new QueryParser(Version.LUCENE_30, "contents", porterAnalyzer)
				.parse("laziness");
