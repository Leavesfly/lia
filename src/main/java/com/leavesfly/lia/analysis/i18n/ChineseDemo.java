package com.leavesfly.lia.analysis.i18n;
...
public class ChineseDemo {
	...
	private static Analyzer[] analyzers = { new SimpleAnalyzer(),
			new StandardAnalyzer(Version.LUCENE_30), new ChineseAnalyzer(), // B
...
/*
 * #A Analyze this text #B Test these analyzers #C Retrieve tokens #D Display
 * analysis
 */
