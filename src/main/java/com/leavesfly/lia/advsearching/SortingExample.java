...
public class SortingExample {
	 ...
	 * output formatting. Later youùll see a reason to look at the explanation
	 * of score . For now, itùs commented out (#7).
	 */
	...
	public static void main(String[] args) throws Exception {
		...
		example.displayResults(query, new Sort(new SortField("category", SortField.STRING),
				SortField.FIELD_SCORE, new SortField("pubmonth", SortField.INT, true)));
