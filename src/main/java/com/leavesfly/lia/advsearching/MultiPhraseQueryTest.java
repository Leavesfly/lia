...
import com.leavesfly.lia.analysis.synonym.SynonymAnalyzer;
import com.leavesfly.lia.analysis.synonym.SynonymEngine;
...
public class MultiPhraseQueryTest extends TestCase {
	...
	/*
	 * #A Any of these terms may be in first position to match #B Only one in
	 * second position
	 */
