package com.leavesfly.lia.extsearch.payloads;
...
public class BulletinPayloadsAnalyzer extends Analyzer {
	...
	public TokenStream tokenStream(String fieldName, Reader reader) {
		BulletinPayloadsFilter stream = new BulletinPayloadsFilter(new StandardAnalyzer(
				Version.LUCENE_30).tokenStream(fieldName, reader), boost);
